...
version(unittest) {
    ...
    import entity.dialects.sqlitedialect;
    import entity.dialects.pgsqldialect;
...
//            writeln(t);
        ...
        }
        {
            ...
            // check EntityManager.save() when id is filled
...
unittest {
    ...
    static assert(getPropertyEmbeddedClassName!(EMUser, "userName") == "entity.tests.EMName");
    ...
    static assert(getPropertyReferencedClassName!(Person, "moreInfo") == "entity.tests.MoreInfo");
    ...
    //  }
    schema = new SchemaInfoImpl!(entity.tests); //Person, MoreInfo, EvenMoreInfo, 
